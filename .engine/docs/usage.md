...
| Run / define a viewpoint | `sysmlv2 view <name> [ROOT]` — executes `.engine/views/<name>.view.toml` (a select + optional traverse + project filter; D0075) and prints the subgraph JSON. Author/edit the `.view.toml` directly; see the `view` skill. |
