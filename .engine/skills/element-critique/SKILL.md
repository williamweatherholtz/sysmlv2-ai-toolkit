...
*all* the assurance machinery: coverage (`keel show coverage`), staleness (`suspect`), the human
...
1. **Scope:** pick targets — prioritize the `keel show coverage` gap set (uncovered requirements/needs
