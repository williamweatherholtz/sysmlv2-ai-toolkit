...
pub const CLI_FACTS: [CliFact; 101] = [
    ...
    CliFact { name: "github-decider", family: "channel", effect: "reads", stability: "stable", invocation: "[<login>]", synopsis: "who may decide on the channel; an unmapped login is refused, never defaulted" },
    CliFact { name: "github-gesture", family: "channel", effect: "reads", stability: "internal", invocation: "(env: COMMENT_BODY ...)", synopsis: "parse a channel comment into a JSON verdict; called by the workflow" },
    CliFact { name: "github-decision-id", family: "channel", effect: "tooling", stability: "internal", invocation: "<id>", synopsis: "split a channel decision id into project and name" },
