...
pub const CLI_FACTS: [CliFact; 110] = [
    ...
    CliFact { name: "new", family: "authoring", effect: "writes", stability: "stable", invocation: "sprint <N> <slug> --charter <dNNNN> [--points P] [--fill FILE]", synopsis: "scaffold a sprint's ceremony record with minted ids; --fill writes its prose from a draft file and never a result (D0301)" },
    ...
    CliFact { name: "reverify", family: "authoring", effect: "writes", stability: "stable", invocation: "[--all-drift | --task N | --demos] [--by A]", synopsis: "re-run the declared gate at HEAD and stamp fresh results where it is green; --demos replays every replayable demo receipt and records each verdict (D0444)" },
